...
class Reimburse extends LFSModel
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'entry_date' => Yii::t('models/model','日期'),
			'entry_memo' => Yii::t('models/model','摘要'),
			'employee_id' => Yii::t('models/model','员工'),
			'travel_amount' => Yii::t('models/model','差旅费'),
			'benefit_amount' => '福利费（餐费等）',
			'traffic_amount' => Yii::t('models/model','交通费'),
			'phone_amount' => Yii::t('models/model','通讯费'),
			'entertainment_amount' => Yii::t('models/model','招待费'),
			'office_amount' => Yii::t('models/model','办公费'),
			'rent_amount' => Yii::t('models/model','租金'),
            'watere_amount' => Yii::t('models/model','水电费'),
			'train_amount' => Yii::t('models/model','培训费'),
			'service_amount' => Yii::t('models/model','服务费'),
			'stamping_amount' => Yii::t('models/model','印花税'),
			'subject' => 'Subject',
			'subject_2' => 'Subject 2',
