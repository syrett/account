...
class Cost extends LFSModel
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'order_no' => Yii::t('models/model','成本结转单号'),
			'entry_date' => Yii::t('models/model','成本结转日期'),
			'entry_name' => Yii::t('models/model','商品名称'),
            'model' => Yii::t('models/model','型号'),
            'count' => Yii::t('models/model','盘点数量'),
            'stocks' => Yii::t('models/model','商品清单'),
			'stocks_count' => Yii::t('models/model','对应数量'),
			'stocks_price' => Yii::t('models/model','对应当时计算价格'),
			'entry_amount' => Yii::t('models/model','成本'),
			'subject' => 'Subject',
			'subject_2' => 'Subject 2',
