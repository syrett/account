...
/**
 * This is the model class for table "project_long".
 *
 * The followings are the available columns in table 'project_long':
 * @property integer $id
 ...
 */
class ProjectLong extends LFSModel
{
    public $assets;
    /**
     ...
     * @return ProjectLong the static model class
     */
    ...
    public function getProject($key=''){
        ...
        if($project != null){
            foreach ($project as $item) {
                $sbj = Subjects::model()->findByAttributes(['sbj_name'=>$item->name], "sbj_number like '1801%'");
                if($sbj!=null)
