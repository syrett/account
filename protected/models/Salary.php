...
class Salary extends LFSModel
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'order_no' => Yii::t('models/model','工资单号'),
			'entry_date' => Yii::t('models/model','工资日期'),
			'employee_id' => Yii::t('models/model','员工姓名'),
			'salary_amount' => Yii::t('models/model','工资'),
			'bonus_amount' => Yii::t('models/model','奖金'),
			'benefit_amount' => Yii::t('models/model','其他福利'),
            'social_personal' => Yii::t('models/model','社保个人'),
            'provident_personal' => Yii::t('models/model','公积金个人'),
            'personal_tax' => Yii::t('models/model','个税'),
            'social_company' => Yii::t('models/model','社保公司'),
            'provident_company' => Yii::t('models/model','公积金公司'),
            'base_amount' => Yii::t('models/model','社保基数'),
			'subject' => 'Subject',
			'subject_2' => 'Subject 2',
