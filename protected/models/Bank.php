...
class Bank extends LFSModel
{
    ...
    public function attributeLabels()
    {
        return array(
            'id' => 'ID',
            'order_no' => Yii::t('models/bank', '订单号'),
            'target' => Yii::t('models/bank', '交易对象'),
            'name' => Yii::t('models/bank', '名称'),
            'department_id' => Yii::t('models/bank', '部门'),
            'client_id' => Yii::t('models/bank', '客户'),
            'date' => Yii::t('models/bank', '日期'),
            'memo' => Yii::t('models/bank', '说明'),
            'amount' => Yii::t('models/bank', '金额'),
            'parent' => Yii::t('models/bank', '父ID'),
            'subject' => Yii::t('models/bank', '科目'),
            'invoice' => Yii::t('models/bank', '有无发票'),
            'tax' => Yii::t('models/bank', '税率'),
            'status_id' => Yii::t('models/bank', 'Status'),
            'created_at' => Yii::t('models/bank', 'Created At'),
            'updated_at' => Yii::t('models/bank', 'Updated At'),
        );
    }
