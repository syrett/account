...
<div class="panel-heading">
    <h2><?= Yii::t('report', '损 益 表') ?></h2>
</div>
<div class="panel-body">
    <p class="text-center"><span class="pull-left"><?= Yii::t('report', '日期') ?>
            ：<?php echo $date; ?></span><?= Yii::t('report', '编制单位') ?>：<?php echo $company ?> <span
...
<table id="profit" class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <th class="text-right"><?= Yii::t('report', '本年累计发生额') ?></th>
        <th class="text-right"><?= Yii::t('report', '本期发生额') ?></th>
    </tr>
    </thead>
    <tr>
        <?php echoData(55, $data, Yii::t('report', "一、营业收入")) ?>
    </tr>
    <tr>
    ...
    <tr>
        <?php echoData("trading_profit", $data, Yii::t('report', "二、营业利润")) ?>
    </tr>
    <tr>
    ...
    <tr>
        <?php echoData("profit_sum", $data, Yii::t('report', "三、利润总额")) ?>
    </tr>
    <tr>
        <?php echoData(68, $data) ?>
    </tr>
    <tr>
        <?php echoData("net_profit", $data, Yii::t('report', "四、净利润")) ?>
    </tr>
    <tr>
        <?php echoData("net_profit", $data, Yii::t('report', "其中：归属于母公司所有者的净利润")) ?>
    </tr>
    <tr>
        <?php echoData(70, $data, Yii::t('report', "加：年(期)初未分配利润")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "其他转入")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "减：提取法定盈余公积")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "提取储备基金")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "提取企业发展基金")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "提取职工奖励及福利基金")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "提取任意盈余公积")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "应付现金股利(利润)")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "其中：分配控股母公司现金股利")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "转作股本的普通股股利")) ?>
    </tr>
    <tr>
        <?php echoData(0, $data, Yii::t('report', "盈余公积补亏")) ?>
    </tr>
    <tr>
        <?php echoData("undistributed_profit", $data, Yii::t('report', "五、未分配利润")) ?>
    </tr>
    </td>
</table>
</div>
<div class="alert">
    ...
    $excel_name = Yii::t('report', "损益表") . '-' . $d . ".xls";
    ?>
