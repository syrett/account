...
<div class="alert alert-info">
    ...
    <h3><?= Yii::t('report', '科目余额表') ?></h3>
    <?= Yii::t('report', '请选择报表日期') ?>：
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h2><?= Yii::t('report', '科目余额表') ?></h2>
        <?php echo $fromMonth . " " . Yii::t('report', '至') . " " . $toMonth ?>
    </div>

    <table id="subjects" class="table table-bordered">
        <thead>
        <tr>
            <th class="text-right"><?= Yii::t('report', '科目编码') ?></th>
            <th class="text-right"><?= Yii::t('report', '科目名称') ?></th>
            <th class="text-right"><?= Yii::t('report', '期初借方') ?></th>
            <th class="text-right"><?= Yii::t('report', '期初贷方') ?></th>
            <th class="text-right"><?= Yii::t('report', '本期发生借方') ?></th>
            <th class="text-right"><?= Yii::t('report', '本期发生贷方') ?></th>
            <th class="text-right"><?= Yii::t('report', '期末借方') ?></th>
            <th class="text-right"><?= Yii::t('report', '期末贷方') ?></th>
        </tr>
        <?php
...
<div class="alert">
    ...
    if ($fm != ""){
    $excel_name = Yii::t('report', "科目余额表 ") . $fromMonth . "-" . $toMonth . ".xls";
    ?>
