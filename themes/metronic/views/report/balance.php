...
<div <?php if (!$data) echo 'style="display:none"'; ?> class="panel panel-default">
    ...
    <div class="panel-body">
        <p class="text-center">
            <span class="pull-left"><?= Yii::t('report', '日期') ?>: <?php echo date('Y-m-d', strtotime($date)); ?></span>
            <?= Yii::t('report', '编制单位') ?>: <?php echo $company ?>
            <span class="pull-right"><?= Yii::t('report', '金额单位：元') ?></span>
        </p>
    </div>
...
<div class="alert">
    ...
    <p class="text-right">
        ...
        echo '<a href="/?r=report/exportbalance" class="btn btn-primary"><i class="glyphicon glyphicon-export"></i>'.Yii::t('report', '导出').'</a>';
        }
        echo CHtml::endForm();
        ?>
    </p>
