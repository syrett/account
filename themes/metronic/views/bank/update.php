...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
		<span class="font-green-sharp"><?= Yii::t('import', '交易信息修改') ?></span>
		</div>
		<div class="actions">
            <?php echo CHtml::link('<i class="glyphicon glyphicon-search"></i>'. Yii::t('import', '已导入数据'), array('/bank'), array('class' => 'btn btn-circle btn-default')); ?>
		    <a href="<?= $this->createUrl('transition/bank') ?>"  class="btn btn-circle btn-info btn-sm"><i class="fa fa-bank"><?= Yii::t('import', '导入银行交易') ?> </a>
