...
<div class="well well-sm head-button">
    ...
    echo "\n";
    echo CHtml::link('<span class="glyphicon glyphicon-plus"></span> 手动录入', array('create'), array('class' => 'btn btn-default'));
    /*
    ...
    */
    ...
    ?>
    <div class="right">
        <? echo CHtml::link('<span class="glyphicon glyphicon-asterisk"></span> 历史数据', array('/' . $type), array('class' => 'btn btn-default')); ?>
...
<div class="panel-body">
    ...
    <div class="row">
        <div class="col-xs-9">
            ...
            <input type="checkbox" class="" name="first" checked/><label>第一行包含数据</label>
