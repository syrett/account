 ...
 * 报表首页的数据；
 *
 * 增值税 一般纳税人 查账的一般都为0，出口、进项转出的都自己填，税控的自己填（维护，采购）；
 * 初始化时，一般纳税人 和 小规模纳税人的数据库有区别，目前只涉及增值税进项销项；
 *
 * 参数设置，添加企业所得税税率；  ::todo
 * 结转时，计提营业所得税， 借 6801 企业所得税费用  贷 应交税费 企业所得税；
 * 小规模纳税人，修改为一般纳税人后，强制用户手动修改主营业务收入子科目的税率，不能存在3%税率；      ::todo
