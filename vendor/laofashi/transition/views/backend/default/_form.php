    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($model, 'preview_url')->widget(
                ...
                [
                    'settings' => [
                        'url' => ['/bank/default/fileapi-upload']
                    ]
                ]
            ) ?>
        </div>
        ...
        <div class="col-sm-12">
            <?= $form->field($model, 'snippet')->widget(
                ...
                [
                    'settings' => [
                        'minHeight' => 200,
                        'imageGetJson' => Url::to(['/bank/default/imperavi-get']),
                        'imageUpload' => Url::to(['/bank/default/imperavi-image-upload']),
                        'fileUpload' => Url::to(['/bank/default/imperavi-file-upload'])
                    ]
                ]
            ) ?>
        </div>
