...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'laofashi\transition\controllers\frontend';
     ...
     */
    public $previewPath = '@statics/web/bank/previews/';

    /**
     * @var string Image path
     */
    public $imagePath = '@statics/web/bank/images/';

    /**
     * @var string Files path
     */
    public $filePath = '@statics/web/bank/files';

    /**
     * @var string Files path
     */
    public $contentPath = '@statics/web/bank/content';

    /**
     * @var string Images temporary path
     */
    public $imagesTempPath = '@statics/temp/bank/images/';

    /**
     * @var string Preview URL
     */
    public $previewUrl = '/statics/bank/previews';

    /**
     * @var string Image URL
     */
    public $imageUrl = '/statics/bank/images';

    /**
     * @var string Files URL
     */
    public $fileUrl = '/statics/bank/files';

    /**
     * @var string Files URL
     */
    public $contentUrl = '/statics/bank/content';
    ...
    public function init()
    {
        ...
        if ($this->getIsBackend() === true) {
            $this->setViewPath('@vova07/bank/views/backend');
        } else {
            $this->setViewPath('@vova07/bank/views/frontend');
        }
    }
