...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'vova07\cash\controllers\frontend';
     ...
     */
    public $previewPath = '@statics/web/cash/previews/';

    /**
     * @var string Image path
     */
    public $imagePath = '@statics/web/cash/images/';

    /**
     * @var string Files path
     */
    public $filePath = '@statics/web/cash/files';

    /**
     * @var string Files path
     */
    public $contentPath = '@statics/web/cash/content';

    /**
     * @var string Images temporary path
     */
    public $imagesTempPath = '@statics/temp/cash/images/';

    /**
     * @var string Preview URL
     */
    public $previewUrl = '/statics/cash/previews';

    /**
     * @var string Image URL
     */
    public $imageUrl = '/statics/cash/images';

    /**
     * @var string Files URL
     */
    public $fileUrl = '/statics/cash/files';

    /**
     * @var string Files URL
     */
    public $contentUrl = '/statics/cash/content';
    ...
    public function init()
    {
        ...
        $this->setViewPath('@vova07/cash/views/backend');
    }
