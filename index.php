...
defined('LoginURL') or define('LoginURL','http://test.abc.com/frontend/web/index.php?r=users/guest/login');
defined('LogoutURL') or define('LogoutURL','http://test.abc.com/frontend/web/index.php?r=users/user/logout');
defined('UserURL') or define('UserURL','http://test.abc.com/backend/web/index.php?r=users%2Fdefault%2Findex');
